...
{
    val mCtx = context
    var mItemClickLisetner:View.OnClickListener?=null
    ...
    override fun newView(context: Context?, cursor: Cursor?, parent: ViewGroup?): View {
        ...
        mainView.setOnClickListener {
            mItemClickLisetner?.onClick(mainView)
        }
        return mainView
    }
    ...
    fun setOnItemClick(listener:View.OnClickListener){
        mItemClickLisetner = listener
    }
